...
Ecological trait database imported here and matched to our species subset
...
lens_traits <- left_join(lens, traits, by="genus_species") #dataframe where you can see original and new counts per species

#find species missing trait data
missing <- lens_traits %>%
  filter_at(vars(Adult_habitat, Activity_period), any_vars(is.na(.)))  #find species missing habitat and/or activity period data

```

**Note: 17 species are missing trait data, we should try our best to fill those in for maximum power in our analyses**
