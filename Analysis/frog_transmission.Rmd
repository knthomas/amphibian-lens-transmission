...
```{r, fig.height=12, fig.width=7, fig.caption = "Phylogeny showing adult lens transmission and ecological traits. Non-italicized values show our t50 (unbolded) and %UVA (bolded) measurements for adults, while italicized values show transmission data calculated from published literature."} 
